...
export async function checkAndSendSLAAlerts() {
    ...
    try {
        ...
        // Envia exclusivamente para o grupo da Liderança Penha
...
/**
 * Envia alerta de conclusão de limpeza (Direcionado para Liderança Penha)
 */
export async function sendCompletionAlert(eventId: string) {
    ...
    try {
        ...
        // Envia exclusivamente para o grupo Liderança Penha
        await sendWhatsAppMessage(message, '120363421745459340-group');
    } catch (error) {
